-- IN_PROGRESS shift with the lead as CACHE_READY and tech1 as INVITED (pending
-- acceptance). Stack on top of users_basic + building_with_10_devices.
...
SELECT :tenant_id, s.id, t.id, 'INVITED', NOW()
